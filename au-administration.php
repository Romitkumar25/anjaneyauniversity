...
<!-- Mirrored from webmarce.com/html/education/blog-grid.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 09 Feb 2023 13:52:05 GMT -->
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="wm-mini-title">
                            <h1>AU Administration</h1> 
                        </div>
                        <div class="wm-breadcrumb">
                            <ul>
                                <li><a href="index-two.php">Home</a></li>
                                <li><a href="#">AU Administration</a></li>
                                ...
                                <ul class="row">
                                    <li class="col-md-4">
                                        ...
                                        <div class="wm-newsgrid-text">
                                            ...
                                            <p>The permanent or long-term president of a committee, company, or other organization.</p>
                                    ...
                                    <li class="col-md-4">
                                        <figure>
                                            ...
                                            <figcaption class="wm-bgcolor">
                                                ...
                                                <h6> <a href="#">Chanceellor</a></h6>
                                            </figcaption>
                                        </figure>
                                        <div class="wm-newsgrid-text">
                                            
                                            
                                            <p>Chancellor (education) A chancellor is a leader of a college or university, usually either the executive or ceremonial head of the university or of a university campus within a university system.</p>
                                            <!-- <a class="wm-banner-btn" href="#">read article</a> -->
                                        </div>
                                    </li>
                                    <li class="col-md-4">
                                        <figure>
                                            ...
                                            <figcaption class="wm-bgcolor">
                                                ...
                                                <h6><a href="#">Vice Chanceellor</a></h6>
                                            </figcaption>
                                        </figure>
                                        <div class="wm-newsgrid-text">
                                            
                                           
                                            <p>VICE-CHANCELLOR is an officer ranking next below a chancellor and serving as deputy to the chancellor.</p>
                                            <!-- <a class="wm-banner-btn" href="#">read article</a> -->
                                        </div>
                                    </li>
                                    <li class="col-md-4">
                                        <figure>
                                            <a href="#"><img src="extra-images/news-grid-4.jpg" alt=""></a>
                                            <figcaption class="wm-bgcolor">
                                               
                                                <h6> <a href="#">Deans</a></h6>
                                            </figcaption>
                                        </figure>
                                        <div class="wm-newsgrid-text">
                                            
                                            
                                            <p>Dean is a title employed in academic administrations such as colleges or universities for a person with significant authority over a specific academic unit, over a specific area of concern, or both.</p>
                                            <!-- <a class="wm-banner-btn" href="#">read article</a> -->
                                        </div>
                                    </li>
                                    <li class="col-md-4">
                                        <figure>
                                            <a href="#"><img src="extra-images/news-grid-5.jpg" alt=""></a>
                                            <figcaption class="wm-bgcolor">
                                               
                                                <h6> <a href="#">Associate Deans</a></h6>
                                            </figcaption>
                                        </figure>
                                        <div class="wm-newsgrid-text">
                                            
                                            
                                            <p>An associate dean is an academic with administrative responsibilities at a university.</p>
                                            <!-- <a class="wm-banner-btn" href="#">read article</a> -->
                                        </div>
                                    </li>
                                    <li class="col-md-4">
                                        <figure>
                                            <a href="#"><img src="extra-images/news-grid-6.jpg" alt=""></a>
                                            <figcaption class="wm-bgcolor">
                                               
                                                <h6> <a href="#">Registrar</a></h6>
                                            </figcaption>
                                        </figure>
                                        <div class="wm-newsgrid-text">
                                            
                                           
                                            <p>The registrar typically holds a master’s degree in academic administration and has a great deal of experience in the scheduling, registration and other organizational requirements of a college.</p>
                                            <!-- <a class="wm-banner-btn" href="#">read article</a> -->
                                        </div>
                                    </li>
        ...
        <div class="action">
            ...
            <i class="fa fa-times"  style="display: none" id="remove"></i>
             ...
             <div class="btns">
                ...
                <a href="https://wa.me//916260244331" target="_blank" class="btn" style="background-color: #25D366;">
                    <i class="fab fa-whatsapp"></i>
                </a>
                <a href="http://instagram.com/anjaneyauniversity" target="_blank" class="btn" style="background-color: #e4405f;">
...
<!-- Mirrored from webmarce.com/html/education/blog-grid.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 09 Feb 2023 13:52:08 GMT -->
